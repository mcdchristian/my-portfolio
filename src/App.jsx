    ...
    <>
      ...
      <section id="home">
        ...
        <div className="hero-socials">
          <a href="https://github.com/mcdchristian" className="social-link" target="_blank" rel="noreferrer"> 
          ...
          <a href="https://www.linkedin.com/in/del-or-mutaliko-5315a2406" className="social-link" target="_blank" rel="noreferrer">
      ...
      <section id="contact">
        ...
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <a href="https://github.com/mcdchristian" className="contact-item" target="_blank" rel="noreferrer">
              ...
              <div><div className="contact-item-label">GitHub</div><div className="contact-item-val">github.com/mcdchristian</div></div>
            </a>
